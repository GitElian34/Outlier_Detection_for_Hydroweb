...
PERIOD = "validation"
OUT_DIR = Path("./Evaluation_Model/residus")
...
RUNS = [
    ...
    {
        "label": "27j",
        "model_dir": "arlstm_feat27jFinalModeleT_3107_111332", # A Changer à la main
        "epoch": 25,
        "data_dir": "./data/IA/Dataset/27j",
        "stations_file": "./data/IA/Dataset/stations_hwnext_27j.txt",
    },
]
