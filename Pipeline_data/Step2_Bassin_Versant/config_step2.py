...
"""
═══════════════════════════════════════════════════════════════════════════
config_Step2.py — Configuration centrale de l'étape 2
═══════════════════════════════════════════════════════════════════════════

SOURCE UNIQUE DE VÉRITÉ pour tous les chemins par défaut de l'étape 2
(sous-modules 2a-2e ET orchestrateur Step2_run_all.py).
...
(ex: HydroSHEDS pointait vers un chemin absolu perso dans Step2a, mais
...
DIR_PATH = "./data/Step2/Hydrosheds/hyd_eu_dir_15s.tif"
ACC_PATH = "./data/Step2/Hydrosheds/hyd_eu_acc_15s.tif"

# ─── 2b — RiverATLAS (ordre de Strahler) ───────────────────────────────
# Version pré-découpée sur l'Europe (RiverATLAS_v10_eu.shp) — plus légère
# à manipuler que le fichier global (2.55 Go). Step2b filtre quand même
...
RIVER_ATLAS_PATH = "./data/Step2/Strahler/HydroSHED/RiverATLAS_v10_eu.shp"

# ─── 2c — SRTM (élévation / pente) ─────────────────────────────────────
DEM_PATH = "./data/Step2/Elevation/srtm_france.tif"
SLOPE_PATH = "./data/Step2/Elevation/slope_france.tif"

# ─── 2d — Corine Land Cover + SoilGrids ────────────────────────────────
CORINE_PATH = "./data/Step2/Soilgrids/U2018_CLC2018_V2020_20u1.tif"
SOILGRIDS_DIR = "./data/Step2/Soilgrids/SoilGrids/"

# ─── 2e — ROE (barrages) ───────────────────────────────────────────────
ROE_DIR = "./data/Step2/Barrage/dataset/"
...
# (ex: retrouver l'ancien comportement "toujours France" de Step2b, ou
...
def bbox_dict_to_tuple(bbox: dict) -> tuple[float, float, float, float]:
    ...
    2a / run_Step2) vers le tuple (left, bottom, right, top) attendu par
