...
from Pipeline_data.Step1_Niveau_deau.step1_importWaterLvL import run_step1
...
def print_final_report(db_path: str):
    ...
    print(f"║  Pixels Step3_ERA5           : {n_pixels:>6d}" + " " * 24 + "║")
    print(f"║  Jours Step3_ERA5            : {n_era5:>6d}" + " " * 24 + "║")
...
def run_pipeline(dossier: str, db_path: str = "./data/test.db",
                 ...
                 era5_base: str = "./data/Step3_ERA5/usable_data_LAND_France") -> dict:
    """
    ...
    Args:
        ...
        era5_base: Chemin racine des fichiers Step3_ERA5
    ...
    if start_step <= 3:
        print("\n" + "█" * 60)
        print("  ÉTAPE 3/3 — Step3_ERA5 sur BV + features")
        print("█" * 60)
        t3 = time.time()
...
Exemples :
  ...
  # Reprendre à l'étape 3 seulement (Step3_ERA5)
